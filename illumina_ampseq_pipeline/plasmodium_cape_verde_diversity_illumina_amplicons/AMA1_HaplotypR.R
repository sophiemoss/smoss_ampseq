...
outputDir <- "/mnt/storage11/sophie/plasmodium_cape_verde/DIV_amplicons/AMA1_v2"
...
demultiplex <- function(pattern, outputDir, sampleNum) {
  # Set input file path
  primerFile <- paste0("/mnt/storage11/sophie/plasmodium_cape_verde/DIV_amplicons/markerFile_AMA1.txt")
...
# Your existing low-depth filter
procReads <- procReads[procReads$numRead > 10, ]
