...
--kit-name SQK-NBD114-96 sup ./all_pod5/ > /mnt/storageG1/data/experiments/Exp_191_Anisa_Anopheles/nanopore_pipeline_out/calls.bam
...
-p /mnt/storage11/sophie/gitrepos/smoss_ampseq/nanopore_ampseq_pipeline/anisa_anopheles/plate_layout_anisa.csv \
-b /mnt/storage11/sophie/gitrepos/smoss_ampseq/nanopore_ampseq_pipeline/anisa_anopheles/internal_barcodes.csv \
-f /mnt/storage11/sophie/anisa/fastq_files \
-o samples.csv \
-m 0 \
-t 8
