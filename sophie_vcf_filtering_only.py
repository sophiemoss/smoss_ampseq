#script to filter the text files of SNPs and INDELs which are generated from the combined VCF files of all samples
# need to install pandas. can do this with conda install -c anaconda pandas
...
### Now move on to filtering the combined INDELS. What filtering steps are required for indels?
